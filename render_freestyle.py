...
# for i in range(1):
  # body
  body_path = f"D:/HarvardCamlab/code/smplparameter2mesh/test/clip1_test_3_{i}.obj"
...
#  body_obj.data.materials[0] = bpy.data.materials.get("emit")
 # lineset0()
  bpy.context.scene.render.filepath = f"D:/HarvardCamlab/code/smplparameter2mesh/images/test_3_{i}.png" 
